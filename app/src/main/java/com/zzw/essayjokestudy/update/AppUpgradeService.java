...
import com.zzw.essayjokestudy.BuildConfig;
import com.zzw.essayjokestudy.R;
...
//                PendingIntent.FLAG_UPDATE_CURRENT);
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        destFile = new File(downloadHelper.getCacheFile(this) + File.separator + fileName);
        initHandler();
        initNotification();
     ...
     * 用于监听文件下载
     */
    private DownloadHelper.DownloadListener downloadListener = new DownloadHelper.DownloadListener() {
        @Override
...
//                    PendingIntent.FLAG_UPDATE_CURRENT);
    ...
    private class AppUpgradeThread extends Thread {
        @Override
        public void run() {
            downloadHelper.download(mDownloadUrl, destFile, downloadListener);
        }
    }
